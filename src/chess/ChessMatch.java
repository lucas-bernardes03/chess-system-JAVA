...
public class ChessMatch {
    ...
    public ChessPiece performChessMove(ChessPosition sourcePosition, ChessPosition targetPosition){
        ...
        //en passant
        if(movedPiece instanceof Pawn && (target.getRow()) == (target.getRow()+2) || (target.getRow()) == (target.getRow()-2)) enPassantVulnerable = movedPiece;
